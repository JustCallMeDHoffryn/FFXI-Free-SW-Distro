...
The important thing to notice is that the window has automatically added a vertical scrolll bar when the size of the content exceeds the size of the **USED** client area.
