--	---------------------------------------------------------------------------
--	This file contains things that need to be easy to access from all the
--	modules, but NOT code
--	---------------------------------------------------------------------------
...
local ETC = {
	...
	Amber 		= T{ 1.0, 0.5, 0.0, 1.0, },
	Magic 		= T{ 1.0, 0.3, 1.0, 1.0, },

}


-- Return the ETC object
